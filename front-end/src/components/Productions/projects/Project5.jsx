      ...
      <>
        <div className="row my-5">
          <div className="col">
            ...
            <p>
              Il s'agissait d'apprendre à utiliser le framework Symfony 4 avec
              Api Platform pour la réalisation d'une Api REST et React pour la
              partie frontend. De loin le projet E-Learning le plus intéressant.
              Il m'a permis de comprendre et de mettre en application les concepts
              d'une api REST mais aussi de m'exercer sur React.
            </p>
          </div>
        </div>
        <div className="row my-5" id="details5" style={{ display: "none" }}>
          ...
          <div className="col-md-6">
            ...
            <video controls>
              <source src="media/mini-crm.mp4" type="video/webm" />
