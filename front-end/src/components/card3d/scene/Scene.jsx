          ...
          <div className="container static-card">
            <div className="row">
              <div className="col text-center">
                  ...
                  <p className="text-danger message">Les effects 3D sont désactivés, l'affichage n'est pas optimisé pour votre écran en mode portrait</p>
              </div>
            </div>
          </div>
        )}
